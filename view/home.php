...
<nav class="teal darken-4" role="presentation">
    <div class="nav-wrapper container">
        <a id="brand"  class="brand-logo">MSR</a>
      <!-- THIS IS WHERE YOU DO THE DROPDOWN for COUNTRY GAGAAAAAAAAAAAAAAAA!!!!
        <ul class="right">
            ...
            <div class="col s12 m4">
                ...
                <div class="patient_block">
                    ...
                    <div class="row center">
                        <a href="http://localhost/GH/?controller=patient&action=display" id="p_login" class=" waves-effect waves-light btn-small">Log In as Patient</a>
                    </div>
                </div>
                </div>
            </div>
