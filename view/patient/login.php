<!-- <html>
<h>Patient Login</h>
<form action="http://localhost/GH/?controller=patient&action=login" method="post">
...
<div class="container">
 <div class = "section">
     <div class="card-panel">
         ...
         <div class="row">
        <form class="col s12" action="http://localhost/GH/?controller=patient&action=login" method="post">
            <div class="row">
